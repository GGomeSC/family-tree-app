...
const initialState: MockPreviewState = {
  detailsOpen: true,
...
function reducer(state: MockPreviewState, action: Action): MockPreviewState {
  switch (action.type) {
    case "toggleDetails":
...
export function useMockPreviewControls(persons: LayoutPerson[]) {
